...
var test_base_1 = require("../utils_ts/test-base");
var POManager_1 = require("../pageobjects_ts/POManager");
//Json->string->js object
var dataset = JSON.parse(JSON.stringify(require("../utils/placeorderTestData.json")));
var _loop_1 = function (data) {
    (0, test_1.test)("@Webs Client App login for ".concat(data.productName), function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var poManager, products, loginPage, dashboardPage, cartPage, ordersReviewPage, orderId, ordersHistoryPage, _c, _d, _e;
        var page = _b.page;
...
(0, test_base_1.customTest)("Client App login", function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var poManager, products, loginPage, dashboardPage, cartPage;
    var page = _b.page, testDataForOrder = _b.testDataForOrder;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.sent();
                return [4 /*yield*/, loginPage.validLogin(testDataForOrder.username, testDataForOrder.password)];
            case 2:
                _c.sent();
                dashboardPage = poManager.getDashboardPage();
                return [4 /*yield*/, dashboardPage.searchProductAddCart(testDataForOrder.productName)];
            case 3:
                _c.sent();
                return [4 /*yield*/, dashboardPage.navigateToCart()];
            case 4:
                _c.sent();
                cartPage = poManager.getCartPage();
                return [4 /*yield*/, cartPage.VerifyProductIsDisplayed(testDataForOrder.productName)];
            case 5:
                _c.sent();
                return [4 /*yield*/, cartPage.Checkout()];
            case 6:
