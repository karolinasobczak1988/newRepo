...
var AccountPage = /** @class */ (function () {
    ...
    AccountPage.prototype.clickDeposit = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.depositButton.click()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.amountField.click()];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.amountField.fill('10')];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.placeDeposit.click()];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Object.defineProperty(AccountPage.prototype, "MessageIsDisplayed", {
        get: function () {
