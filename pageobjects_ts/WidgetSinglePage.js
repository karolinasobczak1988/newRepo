...
exports.WidgetSinglePage = void 0;
var test_1 = require("@playwright/test");
var WidgetSinglePage = /** @class */ (function () {
    function WidgetSinglePage(page) {
        this.page = page;
        ...
        this.greenValue = page.locator(".auto-complete__option:text(\"".concat('Green', "\")"));
        // this.blackValue = page.locator(`.auto-complete__option:text("${'Black'}")`);
    }
    WidgetSinglePage.prototype.selectTypeWidget = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.singleColorWidget.click()];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.singleColorWidget.fill('gr')];
                    case 3:
                        _a.sent();
                    ...
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, this.greenValue.click()];
                    case 6:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    WidgetSinglePage.prototype.getSelectedOptions = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return WidgetSinglePage;
}());
exports.WidgetSinglePage = WidgetSinglePage;
